...
function Footer() {
  return (
    <footer className="text-gray-500 group hover:bg-emerald-950 bg-white py-6 px-4">
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        {/* Réseaux sociaux */}
        <div className="flex flex-col items-center mb-4 group-hover:text-white">
        ...
        <div className="flex flex-col items-center">
          <h3 className="group-hover:text-white text-lg font-semibold mb-3">Abonnez-vous à notre newsletter</h3>
          <input
            type="email"
            placeholder="Entrez votre email"
            className="px-4 py-2 text-black outline-none rounded-md mb-2 w-full"
          />
          <button className="bg-white text-emerald-900 px-4 py-2 border border-gray-400 rounded-md hover:bg-gray-200">S'inscrire</button>
        </div>
      </div>
